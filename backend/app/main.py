    ...
    async with engine.begin() as conn:
        ...
        try:
            ...
            for ddl in (
                ...
                "ALTER TABLE sweepstakes ADD COLUMN IF NOT EXISTS last_update_sent TIMESTAMPTZ",
                "ALTER TABLE users ADD COLUMN IF NOT EXISTS reset_code_hash VARCHAR(255)",
...
async def health():
    ...
    return {"status": "ok", "service": settings.PROJECT_NAME,
            "build": "v71-public-deployment-audit", "poller": POLLER_STATS, "feed": FEED_HEALTH,
